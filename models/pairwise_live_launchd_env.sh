...
export PAIRWISE_GROSS_CAP=0.01
export PAIRWISE_LIVE_MAX_GROSS_CAP=0.01
export PAIRWISE_ALLOW_BACKTEST_LIKE_GROSS_CAP=0
export PAIRWISE_NO_TRADE_BAND_PCT=10
export REBALANCE_NOTIONAL_BAND_USD=25
export PAIRWISE_MAX_HOLD_BARS=288
export PAIRWISE_BREADTH_NOISE_EPSILON=0
export PAIRWISE_CVAR_CUT=1
export PAIRWISE_CVAR_CUT_HOLD_HOURS=24
export PAIRWISE_PROMOTION_FREEZE=1
export PAIRWISE_REGIME_THRESHOLD_SCALE=1.0
export PAIRWISE_REGIME_GATE_DISABLED=0
