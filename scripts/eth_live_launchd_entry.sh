...
export PAIRWISE_PAIR_OVERRIDE="ETHUSDT"
...
STATE_PATH="${PAIRWISE_LIVE_STATE_PATH:-$ROOT_DIR/models/eth_live_state.json}"
DECISION_LOG_PATH="${PAIRWISE_LIVE_DECISION_LOG_PATH:-$ROOT_DIR/logs/eth_decisions.jsonl}"
