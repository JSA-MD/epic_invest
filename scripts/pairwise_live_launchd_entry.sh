...
_PLIST_PAIRWISE_ALLOW_FORCE_DURING_FREEZE="${PAIRWISE_ALLOW_FORCE_DURING_FREEZE-}"
...
if [[ -n "$_PLIST_PAIRWISE_ALLOW_FORCE_DURING_FREEZE" ]]; then
  export PAIRWISE_ALLOW_FORCE_DURING_FREEZE="$_PLIST_PAIRWISE_ALLOW_FORCE_DURING_FREEZE"
  echo "[entry] plist override restored: PAIRWISE_ALLOW_FORCE_DURING_FREEZE=$PAIRWISE_ALLOW_FORCE_DURING_FREEZE" >&2
fi
