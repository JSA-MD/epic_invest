...
export PAIRWISE_PAIR_OVERRIDE="SOLUSDT"
...
STATE_PATH="${PAIRWISE_LIVE_STATE_PATH:-$ROOT_DIR/models/sol_live_state.json}"
DECISION_LOG_PATH="${PAIRWISE_LIVE_DECISION_LOG_PATH:-$ROOT_DIR/logs/sol_decisions.jsonl}"
