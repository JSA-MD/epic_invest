...
export PAIRWISE_PAIR_OVERRIDE="XRPUSDT"
...
STATE_PATH="${PAIRWISE_LIVE_STATE_PATH:-$ROOT_DIR/models/xrp_live_state.json}"
DECISION_LOG_PATH="${PAIRWISE_LIVE_DECISION_LOG_PATH:-$ROOT_DIR/logs/xrp_decisions.jsonl}"
